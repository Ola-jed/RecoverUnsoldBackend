...
namespace RecoverUnsoldApi.Converters;

public class JsonDictionaryConverter<TKey, TValue> : JsonConverter<IDictionary<TKey, TValue>> where TKey : notnull
{
        ...
        JsonSerializerOptions options)
    {
        ...
        var parse = typeof(TKey).GetMethod("Parse", 0, BindingFlags.Public | BindingFlags.Static, null,
...
internal sealed class JsonNonStringKeyDictionaryConverterFactory : JsonConverterFactory
{
    ...
    {
        var converterType = typeof(JsonDictionaryConverter<,>)
